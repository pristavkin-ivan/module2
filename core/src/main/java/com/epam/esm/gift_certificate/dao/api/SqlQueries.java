...
public interface SqlQueries {
    ...
    String UPDATE_DESCRIPTION = "update gift_certificate set g_description = ? where g_id = ?";

    String UPDATE_DURATION = "update gift_certificate set g_duration = ? where g_id = ?";

    String UPDATE_PRICE = "update gift_certificate set g_price = ? where g_id = ?";

    String UPDATE_DATE = "update gift_certificate set g_last_update_date = ? where g_id = ?";
    ...
    String SELECT_ASSOCIATION_BY_TAG_ID = "select * from gifts_tags where tag_id = ? and gift_id = ?";
